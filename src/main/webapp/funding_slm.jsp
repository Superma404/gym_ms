  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">参与的项目</h4>
      </div>
			...
			<div class="col-sm-6 col-sm-offset-3">
				<nav aria-label="Page navigation">
					<ul class="pagination pagination-sm">
						<li><a href="selectFunding?pn=1">首页</a></li>
							<li>
								<a href="selectFunding?pn=${page.pageNum-1}"
						...
						<c:forEach items="${page.navigatepageNums }" var="n">
							...
							<li><a href="selectFunding?pn=${page.pageNum+1 }"
								aria-label="Next"> <span aria-hidden="true">&raquo;</span>
							</a></li>
						<li><a href="selectFunding?pn=${page.pages}">末页</a></li>
					</ul>
				</nav>
		      </div>
                </li>
