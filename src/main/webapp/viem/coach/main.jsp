...
<script type="text/javascript" src="/static/js/js/coach.js"></script>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel2">添加教练</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							<label  class="col-sm-2 control-label">教练课程</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="coCourse"
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<!--部门提交Id  -->
								<select class="form-control" name="coStatus"  >
