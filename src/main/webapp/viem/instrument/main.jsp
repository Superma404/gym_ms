...
<script type="text/javascript" src="/static/js/js/instrument.js"></script>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel2">添加器械</h4>
				</div>
				<div class="modal-body">
					<form class="form-horizontal">
						<div class="form-group">
							<label  class="col-sm-2 control-label">器械名</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="usName"
									id="empName_add" placeholder="Username">
							</div>
						</div>
						<div class="form-group">
							<label  class="col-sm-2 control-label">器械用途</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label  class="col-sm-2 control-label">器械状态</label>
							<div class="col-sm-4">
								<!--部门提交Id  -->
