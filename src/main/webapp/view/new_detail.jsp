...
<head>
    ...
    <script type="text/javascript" src="<c:url value='static/js2/new_detail.js'/>"></script>
    ...
    <link rel="stylesheet" href="<c:url value='/static/css/detail.css'/>" type="text/css"/>
    <title>Title</title>
</head>
<body>
<div id="header">
...
<div class="product">
        ...
        <div class="product-left">
            <table class="table table-bordered">
                <tr class="text-center">
                    ...
                    <td class="active title-td"><a href="proCheck?address=selectPro_c">详细描述</a></td>
    ...
    <div class="product-form">
        ...
        <hr>
        <!--编辑信息表单-->
        <form id="detail_frm" action="addProc" method="post">
         <input type="hidden" name="proUsId" value="${user.usId}" />
            <div class="my-form">
