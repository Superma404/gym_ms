...
<body>
	<div id="header">
		<div class="heade-con">
			<div class="logo">
				<a href=""><img src="<c:url value='/static/images/LOGO.png'/>" /></a>
			</div>
			<div class="nav posa">
				<ul>
					...
					<li><a href="indexCheck?address=new_info" style="">发布项目</a></li>
				</ul>
			</div>
			<div class="search">
				<form action="">
						...
						<form id="register_frm">
							...
							<div id="usEmail_div">
								<label class="block clearfix"> <span
									class="block input-icon input-icon-left"> <input
										type="text" name="usEmail" class="form-control"
							...
							<div id="usName_div">
								...
								<div ><label class="block clearfix"> <span> <input
										type="text" name="usIdcard" class="" placeholder="验证码" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<div class="clearfix">
									...
									<button type="button"  
										class="width-65 pull-right btn btn-sm btn-success disabled"
										id="register_btn">
