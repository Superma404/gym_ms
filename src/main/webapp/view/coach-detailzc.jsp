...
<div class="p-detail_contit">
    ...
    <div class="p-detail-tab2">
        <ul>
            <li><a class="p-detail-tab2-tb" href="product-detailzc">教练信息</a></li>
        </ul>
    </div>
    <div class="p-detail_con2">
        <div class="p-detail_con2l">
            ...
            <div style="width:675px;height:445px;margin:30px auto">
                <img  style="width: 650px;height: 450px" src="/upload/timg11.jpg" alt="">
            </div>
...
<div class="p-detail_txt1">
    ...
    <h3>教练介绍</h3>
    <p>
        李教练，即在踏板上随着动感音乐（每分钟120拍左右）有节奏地上下舞动，进行健美操的动作和步伐。它具有健美操的所有特点，同时，由于大部分动作是在踏板上完成，所以能更有效地增强心肺功能及协调性。因其主要针对的部位是下肢和臀部，具有明显耗能减脂（一节课可以消耗1000～1500千卡热能），提臀美腿，改善女性肌肉线条的功效。
    </p>
    <p>
    ...
    <p>
        在健身馆里，踏板操备受女性青睐。李教练，对练习者的舞蹈水平无太多要求，适宜人群较为广泛，是一种适合现代女性改善形体的运动项目。
    </p>
    ...
    <form action=""><input class="textarea2-tji" type="submit" value="提交" /></form>
        ...
        <div class="p-detail_con2r">
            ...
            <div class="p-detail_con2r1">
                <div class="p-detail_con2r1tit">擅长课程</div>
                <div class="p-detail_con2r1min">1、搏击操<br>
                    2、瘦身操</div>
                ...
                <div class="detali-fqrxx">
                    <div class="detali-fqrxx_header">
                        <button  style="width: 160px;height: 50px;" type="button" class="btn btn-default btn-lg">
                            <span style="margin-top: 15px" class="glyphicon glyphicon-hand-right" aria-hidden="true"></span> <a style="margin-top: -3px;margin-left: 15px" href="getAllCoach">预约该教练</a>
                        </button></div>
