...
<div class="product-con">
    <h1 class="product-con_tit">所有课程</h1>
    <div class="product-con_nav">
        <a class="lnav_bg" href=""><i><img src="<c:url value='/static/images/ii_04.png'/>" alt=""/></i>全部</a>
        <a href=""><i><img src="http://localhost:8080/static/images/ii_06.png" alt=""/></i>有氧锻炼</a>
        <a href=""><i><img src="http://localhost:8080/static/images/ii_08.png" alt=""/></i>腿部锻炼</a>
        <a href=""><i><img src="http://localhost:8080/static/images/ii_10.png" alt=""/></i>增肌锻炼</a>
        <div class="select-li">
            <span>状态:</span>
            ...
            <c:forEach items="${page.list}" var="p">
                <li class="cz">
                    <div class="product-list-lpic">
                        <a href="product-detailzc"><img src="<c:url value='/upload/${p.couImg}'/>" alt=""/></a>
                        <div class="product_one">待开课</div>
                    </div>
                    <p><a href="">${p.couName}</a></p>
