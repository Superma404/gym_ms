...
<div class="p-detail_con">
	...
	<div class="p-detail-tab2">
		<ul>
			<li><a class="p-detail-tab2-tb2" href="">项目主页</a></li>
			<li><a class="p-detail-tab2-tb" href="">发表留言</a></li>
		</ul>
	</div>
	<div class="p-detail_con2">
		<div class="p-detail_con2l">
			...
			<div style="width:675px;height:445px;margin:30px auto">
				<textarea rows="3" cols="20" style="height: 250px;width: 550px">
    			</textarea><br><br>

					<a href="http://localhost:8080/getAllCourse">提交</a>
